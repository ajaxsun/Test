...
public class WheelTime {
    ...
    private static final int DEFAULT_START_MINT = 1;
    private static final int DEFAULT_END_MINT = 59;
    ...
    private int start_MIN = DEFAULT_START_MINT;
    private int endHOUR_OF_MINT = DEFAULT_END_MINT;
      ...
      /*  wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字*/
       ...
       /* wv_seconds.setLabel(context.getString(R.string.pickerview_seconds));// 添加文字*/
        ...
        OnItemSelectedListener wheelListener_hour = new OnItemSelectedListener() {
            @Override
            public void onItemSelected(int index) {
                int lastposition = wv_hours.getCurrentItem();
                Log.d("loastpositino:", lastposition + "");
    ...
    public void setRangDate(Calendar startDate, Calendar endDate) {
        ...
        if (startDate == null && endDate != null) {
            ...
            int HOUR_OF_DAY = endDate.get(Calendar.HOUR_OF_DAY);
            int MINUTE = endDate.get(Calendar.MINUTE);
            if (year > startYear) {
                this.endYear = year;
                this.endMonth = month;
                this.endDay = day;
                this.endHOUR = HOUR_OF_DAY;
                this.endHOUR = MINUTE;
            } else if (year == startYear) {
                if (month > startMonth) {
                    this.endYear = year;
            ...
            int HOUR_OF_DAY = startDate.get(Calendar.HOUR_OF_DAY);
            int MINUTE = startDate.get(Calendar.MINUTE);
            if (year < endYear) {
                this.startMonth = month;
                this.startDay = day;
                this.startYear = year;
                this.startHOUR = HOUR_OF_DAY;
                this.start_MIN = MINUTE;
            } else if (year == endYear) {
                if (month < endMonth) {
                    this.startMonth = month;
                    this.startDay = day;
            ...
            this.start_MIN = startDate.get(Calendar.MINUTE);
            this.endHOUR_OF_MINT = startDate.get(Calendar.MINUTE);
